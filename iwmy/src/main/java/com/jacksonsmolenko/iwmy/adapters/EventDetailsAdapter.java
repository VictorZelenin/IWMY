...
public class EventDetailsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    /*
    * it is testing unit, todo refactoring
    * */
    @Override
    ...
    // this is first version, it should get info from List<Event>, where event has chosen
    // in right position from list
    ...
    // it should fill up photos dynamically
